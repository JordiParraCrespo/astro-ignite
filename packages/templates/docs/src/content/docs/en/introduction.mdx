...
**astro-ignite** is a shadcn-style CLI for bootstrapping production-grade Astro sites. You answer five prompts and you get a finished site with SEO, i18n, performance, legal, and email pre-wired.
...
If you want to read about the philosophy, head to **The five prompts**. If you want to see code, jump straight to **Quick start**.
