...
<Callout variant="tip" title="Editing content">
  Posts and projects are MDX. Drop components like this callout straight into
  the body — they're available without an import.
</Callout>
