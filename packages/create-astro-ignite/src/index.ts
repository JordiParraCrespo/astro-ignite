...
function printHelp(): void {
  // eslint-disable-next-line no-console
  console.log(`
${kleur.bold('astro-ignite')} — bootstrap a production-grade Astro site

${kleur.bold('Usage:')}
  npm create astro-ignite@latest [project-dir] [options]
  pnpm create astro-ignite@latest [project-dir] [options]
  yarn create astro-ignite [project-dir] [options]
  bun create astro-ignite [project-dir] [options]
