...
- Locked practices below are encoded as machine-checked invariants in `openspec/specs/<capability>/spec.md`. Boundary `AGENTS.md` files at `packages/*/`, `apps/*/`, and `scripts/*/` (each symlinked to `CLAUDE.md`) point at the relevant spec.
