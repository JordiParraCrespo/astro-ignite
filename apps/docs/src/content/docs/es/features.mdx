...
- Imagen OG por defecto en `public/og/og-default.png`; sobrescribe por locale o por página vía frontmatter
...
- 19 primitivos: button, link, text, badge, card, input, textarea, label, separator, alert, avatar, skeleton, kbd, tabs, accordion, dialog, dropdown-menu, tooltip, toast
...
- Geist Sans + Mono auto-alojados vía `astro:fonts` (cero CLS al cambiar)
