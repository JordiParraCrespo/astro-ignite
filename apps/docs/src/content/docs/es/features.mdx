...
Un registro estilo shadcn de primitivos puros de Astro. Vienen **preinstalados** en `src/components/ui/` en ambas plantillas — son tuyos, cada línea. Para reutilizar uno en otro proyecto, cópialo desde el código fuente del registro.

- 24 primitivos: button, link, text, badge, card, input, textarea, label, separator, alert, avatar, skeleton, kbd, tabs, accordion, dialog, dropdown-menu, tooltip, toast, checkbox, switch, select, copy-button, radio-group
