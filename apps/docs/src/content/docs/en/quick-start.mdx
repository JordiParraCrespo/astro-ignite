...
- Node 22.12 LTS or later (required by `@astrojs/node@^11` in the starter template)
...
<Steps>
  <Step title="Scaffold a new site">
    ...
    You'll be asked eight questions. Pick or accept defaults; the whole flow takes around fifteen seconds.
