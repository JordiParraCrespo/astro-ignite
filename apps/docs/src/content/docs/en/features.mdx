...
- Default OG image at `public/og/og-default.png`; override per-locale or per-page via frontmatter
...
- 19 primitives: button, link, text, badge, card, input, textarea, label, separator, alert, avatar, skeleton, kbd, tabs, accordion, dialog, dropdown-menu, tooltip, toast
