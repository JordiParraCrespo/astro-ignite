...
- [x] **T1** — Add the `errors.404.search` key to
...
- [x] **T5** — Mirror T1 in `apps/docs/src/i18n/en.json` and
      `apps/docs/src/i18n/es.json` (add the `errors.404.search` key
      with the same values).
      _Covers: S8, S9._
- [x] **T6** — Mirror T2: create
      ...
      _Covers: S6, S9._
- [x] **T7** — Mirror T3: create `apps/docs/src/pages/404.astro` —
      verbatim copy of the template page.
      _Covers: S1, S3, S9._
- [x] **T8** — Mirror T4: create `apps/docs/src/pages/[lang]/404.astro`
...
- [x] **T12** — Run `pnpm scaffold:test`. Confirm the scaffolded
      ...
      _Covers: S1, S2, S11._
- [x] **T13** — Run `pnpm perf:budget` against the docs build for the
...
- [x] **T14** — Manual smoke: `pnpm dev:docs-template`, request
