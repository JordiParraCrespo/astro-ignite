...
- [ ] **T2.** Update `src/pages/index.astro` to import and render
...
- [ ] **T3.** Update `src/pages/[lang]/index.astro` to import and render
...
- [ ] **T5.** Replace the body of `src/pages/about.astro` with
...
- [ ] **T6.** Apply T5 to `src/pages/[lang]/about.astro` — same body,
...
- [ ] **T8.** Update `src/pages/contact.astro` body to
...
- [ ] **T9.** Apply T8 to `src/pages/[lang]/contact.astro`. Confirm
...
- [ ] **T11.** Update `src/pages/blog/index.astro` body to
...
- [ ] **T12.** Apply T11 to `src/pages/[lang]/blog/index.astro`. Confirm
      import-set equality. Covers **S3**.
...
- [ ] **T14.** Update `src/pages/projects/index.astro` body to
...
- [ ] **T15.** Apply T14 to `src/pages/[lang]/projects/index.astro`.
      Confirm import-set equality. Covers **S3**.

- [ ] **T16.** Refactor `src/pages/404.astro` to composition-only.
...
- [ ] **T17.** Run a tree audit: for every refactored page, confirm
...
- [ ] **T18.** For each page that has a `[lang]/` parallel
...
- [ ] **T22.** Run `pnpm typecheck` from the repo root. Confirm exit 0.
...
- [ ] **T24.** Run `pnpm scaffold:test`. Confirm exit 0 — CLI scaffolds
      the starter into a clean `apps/playground/`, installs, builds,
      Lighthouse. Covers **S8**.

- [ ] **T25.** Run `pnpm perf:budget` against the starter. Capture the
      report under
...
- [ ] **T26.** Run `git diff --name-only main` and confirm the touched
...
- [ ] **T27.** Add a changeset under `.changeset/` summarising the
